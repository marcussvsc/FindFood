...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { cost: @dish.cost, name: @dish.name, time_to_prepare: @dish.time_to_prepare } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { cost: @dish.cost, name: @dish.name, time_to_prepare: @dish.time_to_prepare } }
